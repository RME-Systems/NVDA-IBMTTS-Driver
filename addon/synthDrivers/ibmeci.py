...
#	Prevents the synth from spelling out everything if a punctuation mark follows a word.
	...
	#Remove the two spaces separator between strings containing left and right brackets, parentheses and quotes to reduce verbosity.
...
german_fixes = {
	...
	re.compile(br'(audio|general|macro|video)(-)(en[a-z]+)', re.I): br'\1 `0 \3',
}
german_ibm_fixes = {
